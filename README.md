...
A NeoForge modpack for Minecraft 1.21.1 built around a 10-tier progression chain: build the **Titan Core**, feed it shards (Mote → Heart of the Titan), and unlock the world's response one tier at a time. Endgame is the **Cronos** boss fight, gated behind the final shard.
...
- **Quests:** FTB Quests, 10-tier chain (Mote of the Titan → Heart of the Titan → Cronos)
...
The shard chain (T1–T10) and Cronos boss gateway are implemented but **not yet end-to-end tested in-game** as of 2026-05-08.
